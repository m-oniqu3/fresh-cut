...
const teamInfo = [
  {
    ...
    description:
      "Looking for a high-end barbering experience? Look no further than Donny. With years of experience he gives his clients the perfect cut, every time. He's also a master of color, so if you're looking to add a little something extra to your look, Don is your man. Book your appointment with Donny today and you'll be sure to walk out of the salon looking and feeling your best.",
  },
  {
    id: "toris",
    name: "Toris Dorelli",
    ...
    description:
      "Toris is one of the best.  10 years in the business and he has mastered the art of cutting hair. He is always up-to-date on the latest trends and knows how to style any hair type. Toris is also a great listener and takes the time to understand each client's individual needs. He always strives to provide the best possible service and leaves every client looking and feeling their best. ",
  },
  {
    id: "luca",
    name: "Luca Bianchi",
    ...
    description:
      "want a luxurious haircut experience? then you need to book with Luca.  His precision and attention to detail is unmatched, and he always makes sure to listen to his clients to ensure they get the cut they really want. Trust us, Luca is the one of best in the business and you won't be disappointed!",
  },
  {
    id: "marcus",
    name: "Marcus Bryant",
    ...
    description:
      "Marcus is an experienced barber who takes pride in his work. He is especially skilled in cutting and styling men's hair, and is always up-to-date on the newest styles. He has a friendly and personable demeanor which puts clients at ease, and he always goes the extra mile to ensure they are happy with their service. If you are looking for a top-notch haircut and styling experience, Marcus is the barber for you!",
  },
];
...
const getPictureInfo = (id) => {
  teamInfo.filter((member) => {
    if (member.id === id) {
      teamMemberPicture[0].setAttribute("src", member.image);
      barberName.innerHTML = member.name;
